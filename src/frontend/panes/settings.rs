//! Settings pane - Probe, collection, UI, and persistence settings
//!
...
pub fn render(
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        render_collection_section(shared, ui, &mut actions);
        ui.separator();

        render_persistence_section(shared, ui);
        ui.separator();

        render_display_section(shared, ui);
...
fn render_probe_section(
    ...
    ui.horizontal(|ui| {
        ...
        egui::ComboBox::from_id_salt("settings_connect_under_reset")
    ...
    ui.horizontal(|ui| {
        ...
        egui::ComboBox::from_id_salt("settings_memory_access_mode")
    ...
    ui.horizontal(|ui| {
        ui.label("Probe:");
        egui::ComboBox::from_id_salt("settings_pane_probe_selector")
            .selected_text(
                state
...
fn render_persistence_section(shared: &mut SharedState<'_>, ui: &mut Ui) {
    ...
    if shared.persistence_config.enabled {
        ...
        ui.horizontal(|ui| {
            ...
            let mut size_gb =
                shared.persistence_config.max_file_size as f64 / (1024.0 * 1024.0 * 1024.0);
            if ui
        ...
        ui.horizontal(|ui| {
            ui.label("Format:");
            egui::ComboBox::from_id_salt("settings_persistence_format")
